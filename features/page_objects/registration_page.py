...
class RegistrationPage(BasePage):
    ...
    marketing_agreement_checkbox = (By.CSS_SELECTOR, 'data-key="marketingAccepted"')
    create_button = (By.CSS_SELECTOR, '.create-new-account-page__register-button')
    ...
    def get_required_register_fields(self) -> None:
        ...
        self.get_agreement_error(self.marketing_agreement_checkbox)
    ...
    def accept_agreements_checkoboxes(self) -> None:
        ...
        self.find_element(*self.marketing_agreement_checkbox).click()
